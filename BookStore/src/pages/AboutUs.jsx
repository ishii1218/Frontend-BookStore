  ...
  return (
    <div className='mt-12'>
        ...
        <div className="relative font-sans before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-70 before:z-10">
          <img src="\Images\Bookimage.jpg" alt="Banner Image" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="bg-green-50 p-8 min-h-[350px] flex flex-col items-center justify-center font-[sans-serif] text-[#333]">
            ...
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 max-lg:gap-12">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">The level of user engagement with the applications content and features.</p>
              </div>
              <div className="text-center">
      ...
      <div>
        <h3 className="text-xl font-extrabold text-gray-800">Exceptional Service: Prompt Delivery and Enjoyable Dining Experience.</h3>
        <p className="mt-4 text-sm text-gray-800">The service was amazing. I never had to wait that long for my food. The staff was friendly and attentive, and the delivery was impressively prompt.</p>

        <div className="mt-8 text-left">
          <h4 className="text-base font-bold">Mark Adair</h4>
          <p className="text-xs text-gray-500 mt-0.5">markadair23@gmail.com</p>
        </div>
